define(['jquery', 'geojson', 'json!vendor/EARLY_VOTING_AddressPoints.geojson', 'moment', 'map_service'], function($, GeoJSON, earlyPollJSON,  moment, mapService) {
    'use strict';
